...
- `boot_command` (array of strings) - This is an array of commands to type
  ...
  itself. See the [examples](https://github.com/xenserver/packer-plugin-xenserver/tree/main/examples) for working boot commands that launch autoinstall and kickstart.
...
- `host_port_min` and `host_port_max` (integer) - The minimum and
...
See the [examples](https://github.com/xenserver/packer-plugin-xenserver/tree/main/examples) for working boot commands.
