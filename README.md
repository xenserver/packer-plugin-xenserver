 ...
 * `network_count` - the count of networks which need to connect with host's PIFs.
 * `connect_management_network` - should the vm be connected with host internal management network.
