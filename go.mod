module github.com/xenserver/packer-plugin-xenserver
...
require (
	...
	xenapi v0.0.0-00010101000000-000000000000 // v0.0.0-00010101000000-000000000000 is a pseudo-version to ensure the replace directive works correctly
)
