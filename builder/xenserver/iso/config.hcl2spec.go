...
type FlatConfig struct {
	...
	Username                  *string           `mapstructure:"remote_username" cty:"remote_username"`
	Password                  *string           `mapstructure:"remote_password" cty:"remote_password"`
	HostIp                    *string           `mapstructure:"remote_host" cty:"remote_host"`
	VMName                    *string           `mapstructure:"vm_name" cty:"vm_name"`
	VMDescription             *string           `mapstructure:"vm_description" cty:"vm_description"`
	SrName                    *string           `mapstructure:"sr_name" cty:"sr_name"`
	FloppyFiles               []string          `mapstructure:"floppy_files" cty:"floppy_files"`
	NetworkNames              []string          `mapstructure:"network_names" cty:"network_names"`
	ExportNetworkNames        []string          `mapstructure:"export_network_names" cty:"export_network_names"`
	HostPortMin               *uint             `mapstructure:"host_port_min" cty:"host_port_min"`
	HostPortMax               *uint             `mapstructure:"host_port_max" cty:"host_port_max"`
	BootCommand               []string          `mapstructure:"boot_command" cty:"boot_command"`
	ShutdownCommand           *string           `mapstructure:"shutdown_command" cty:"shutdown_command"`
	RawBootWait               *string           `mapstructure:"boot_wait" cty:"boot_wait"`
	ToolsIsoName              *string           `mapstructure:"tools_iso_name" cty:"tools_iso_name"`
	HTTPDir                   *string           `mapstructure:"http_directory" cty:"http_directory"`
	HTTPPortMin               *uint             `mapstructure:"http_port_min" cty:"http_port_min"`
	HTTPPortMax               *uint             `mapstructure:"http_port_max" cty:"http_port_max"`
	SSHKeyPath                *string           `mapstructure:"ssh_key_path" cty:"ssh_key_path"`
	SSHPassword               *string           `mapstructure:"ssh_password" cty:"ssh_password"`
	SSHPort                   *uint             `mapstructure:"ssh_port" cty:"ssh_port"`
	SSHUser                   *string           `mapstructure:"ssh_username" cty:"ssh_username"`
	...
	SSHHostPortMin            *uint             `mapstructure:"ssh_host_port_min" cty:"ssh_host_port_min"`
	SSHHostPortMax            *uint             `mapstructure:"ssh_host_port_max" cty:"ssh_host_port_max"`
	SSHSkipNatMapping         *bool             `mapstructure:"ssh_skip_nat_mapping" cty:"ssh_skip_nat_mapping"`
	...
	KeepVM                    *string           `mapstructure:"keep_vm" cty:"keep_vm"`
	IPGetter                  *string           `mapstructure:"ip_getter" cty:"ip_getter"`
	VCPUsMax                  *uint             `mapstructure:"vcpus_max" cty:"vcpus_max"`
	VCPUsAtStartup            *uint             `mapstructure:"vcpus_atstartup" cty:"vcpus_atstartup"`
	VMMemory                  *uint             `mapstructure:"vm_memory" cty:"vm_memory"`
	DiskSize                  *uint             `mapstructure:"disk_size" cty:"disk_size"`
	CloneTemplate             *string           `mapstructure:"clone_template" cty:"clone_template"`
	VMOtherConfig             map[string]string `mapstructure:"vm_other_config" cty:"vm_other_config"`
	ISOChecksum               *string           `mapstructure:"iso_checksum" cty:"iso_checksum"`
	...
	ISOUrl                    *string           `mapstructure:"iso_url" cty:"iso_url"`
	ISOName                   *string           `mapstructure:"iso_name" cty:"iso_name"`
	PlatformArgs              map[string]string `mapstructure:"platform_args" cty:"platform_args"`
	RawInstallTimeout         *string           `mapstructure:"install_timeout" cty:"install_timeout"`
}
...
func (*FlatConfig) HCL2Spec() map[string]hcldec.Spec {
	s := map[string]hcldec.Spec{
		...
		"vm_other_config":              &hcldec.BlockAttrsSpec{TypeName: "vm_other_config", ElementType: cty.String, Required: false},
		...
		"platform_args":                &hcldec.BlockAttrsSpec{TypeName: "platform_args", ElementType: cty.String, Required: false},
